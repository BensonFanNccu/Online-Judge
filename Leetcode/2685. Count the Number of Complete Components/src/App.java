public class App {
    public static void main(String[] args) throws Exception {
        ...
        int[][] case1 = new int[][] {{0, 1}, {0, 2}, {1, 2}, {3, 4}};
        int[][] case2 = new int[][] {{0, 1}, {0, 2}, {1, 2}, {3, 4}, {3, 5}};

        System.out.println(sol.countCompleteComponents(6, case1));
        System.out.println(sol.countCompleteComponents(6, case2));
    }
}
